...
type GuacamoleReader interface {
	...
	//  *                            available data.
	Available() (ok bool, err exp.ExceptionInterface)
	...
	//  *                            stream.
	Read() (ret []byte, err exp.ExceptionInterface)
	...
	//  *                            parsed.
	ReadInstruction() (ret gprotocol.GuacamoleInstruction, err exp.ExceptionInterface)
}
